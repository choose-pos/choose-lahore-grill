    ...
    <footer className="pt-12 pb-6 px-4 font-primary bg-bg1 text-textColor">
      <div className="container mx-auto grid md:grid-cols-4 gap-8 md:gap-12">
        ...
        <div className="flex flex-col items-start md:pl-10 !w-full">
          <div className="mb-4 h-[80px] md:h-[60px] w-full relative">
            <Image
          ...
          <div className="flex items-center">
            {socialInfo.facebook ? (
              ...
              >
                <svg
                  ...
                  className="w-6 h-6 fill-textColor" // Add size
                >
            ...
            {socialInfo.instagram ? (
              <Link href={`${socialInfo.instagram}`} target="_blank">
                <svg
                  role="img"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
        ...
        <div>
          ...
          <div className="md:space-y-2 space-y-1 flex flex-col items-start justify-center">
            <Link passHref target="_blank" href={`tel:+1${contact.phone}`}>
              <p className="font-primary text-opacity-80">
                {formatUSAPhoneNumber(contact.phone)}
              </p>
            </Link>
            <Link passHref target="_blank" href={`mailto:${contact.email}`}>
              <p className="font-primary  text-opacity-80">{contact.email}</p>
            </Link>
          </div>
        </div>
      </div>
