  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center px-4 py-12">
      <div className="max-w-2xl mx-auto text-center">
        {/* Title */}
        <h1 className="text-4xl md:text-5xl font-subheading-oo font-bold text-gray-800 mb-6">
          {`The offer you are currently looking for does not exist`}
        </h1>

        {/* Description */}
        <p className="text-lg md:text-xl font-body-oo text-gray-600 mb-8 leading-relaxed">
        ...
        <Link href={"/"} aria-label="Back Link">
          <button
            ...
            className={`md:px-6 px-4 py-2 border-2 border-bg1 text-[20px] font-subheading-oo uppercase bg-bg3  font-medium rounded-[10px] text-bg1 transition-opacity duration-500`}
          >
            {`Back to Home`}
          </button>
        </Link>
